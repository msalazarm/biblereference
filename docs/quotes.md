...
*Division of labour and sequencing are now governed by
`churchfathers/review/quotes_response.md` (2026-08-16) and its reply: their sweeps are
paused on items 1–3; they build the patristic n-gram model and the Latin recall set; item 4
ships first here after the fetches.*
